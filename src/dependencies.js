...
const applyUMD = content => {
  ...
  return [
    ...
    IND.repeat(2) + 'if (root.document) {',
    IND.repeat(3) + 'module.exports = factory(root);',
    IND.repeat(3) + 'module.exports.default = (module.exports.default || module.exports);',
    IND.repeat(2) + '} else {',
    IND.repeat(3) + 'factory.default = factory;',
    IND.repeat(3) + 'module.exports = factory;',
    IND.repeat(2) + '}',
